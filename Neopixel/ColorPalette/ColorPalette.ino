...
//        if( secondHand == 25)  { SetupBlackAndWhiteStripedPalette();       currentBlending = NOBLEND; }
        if( secondHand == 25)  { currentPalette = myRedWhiteGreenPalette_p;currentBlending = NOBLEND; }
        if( secondHand == 30)  { currentPalette = myRedWhiteGreenPalette_p;currentBlending = LINEARBLEND; }
        ...
        if( secondHand == 45)  { currentPalette = myRedWhiteBluePalette_p; currentBlending = NOBLEND;  }
